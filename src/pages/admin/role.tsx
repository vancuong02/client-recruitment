...
const RolePage = () => {
    ...
    const [searchParams, setSearchParams] = useState({
        ...
        limit: new URLSearchParams(window.location.search).get('limit') || LIMIT,
    })
    ...
    const handleOnChangePagination = (page: number, pageSize: number | undefined) => {
        setSearchParams({
            page: page.toString(),
    ...
    return (
        <div>
            ...
            <ModalRole openModal={openModal} setOpenModal={setOpenModal} reloadTable={reloadTable} />
        </div>
    )
}
